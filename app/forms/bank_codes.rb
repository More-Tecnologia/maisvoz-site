module BankCodes
  ...
  BANK_CODES = [
    ...
    ["Banco BMFBovespa de Serviços de Liquidação e Custódia S/A", "096"],
    ["Banco BMG S.A.", "318"],
    ...
    ["Banco Credit Agrícole Brasil S.A.", "222"],
    ...
    ["Banif - Bco Internacional do Funchal (Brasil) S.A.", "719"],
    ["Bank of America Merrill Lynch Banco Múltiplo S.A.", "755"],
    ["Barigui Companhia Hipotecária", "268"],
    ["BBN Banco Brasileiro de Negocios S.A.", "081"],
    ...
    ["Central de Cooperativas de Economia e Crédito Mútuo do Est RS - Unicred", "091"],
    ...
    ["Coop de Créd. Mútuo dos Despachantes de Trânsito de SC e Rio Grande do Sul", "016"],
    ...
    ["Cooperativa de Economia e Crédito Mútuo dos Servidores Públicos Estaduais do Rio", "190"],
    ...
    ["Pólocred Sociedade de Crédito ao Microempreendedor e à Empresa de Pequeno Porte", "093"],
