module Backoffice
  module ProductsHelper
    ...
    def photos_hint
      "#{Product::PHOTO_WIDTH} x #{Product::PHOTO_HEIGHT} (#{t(
        'backoffice.admin.media_files.form.maximum_number_of_photos', maximum_number: Product::MAXIMUM_NUMBER_OF_PHOTOS
      )})"
    end
    ...
    def free_product_purchased?
      current_user.orders.includes(:products).where(products: { kind: :free }).any?
    end
  end
end
