namespace :import_cities do
  ...
  task run: :environment do
    ...
    cities = [
      ...
      ['PA', "Eldorado dos Carajás",1502954],
      ['PA', "Faro",1503002],
      ...
      ['PA', "Santa Isabel do Pará",1506500],
      ...
      ['RN', "São Miguel de Touros",2414407],
      ...
      ['RS', "Santana do Livramento",4317103],
      ['RS', "Santiago",4317400],
      ...
      ['TO', "São Valério da Natividade",1720499],
