namespace :import_products do
  ...
  task run: :environment do
    ...
    products = [
      ...
      { name: 'H-Max Flex 1.0 a 2.0', price_cents: 230000, binary_score: 700, quantity: '1 peça', description: desc, category: flexC, kind: :product, height: 15.8, width: 15.8, length: 8.4, weight: 1.5, sap_code: '00001' },
      { name: 'H-Max Flex 2.1 a 3.2', price_cents: 350000, binary_score: 900, quantity: '1 peça', description: desc, category: flexC, kind: :product, height: 15.8, width: 15.8, length: 8.4, weight: 1.5, sap_code: '00002' },
      { name: 'H-Max Flex 3.3 a 5.2', price_cents: 500000, binary_score: 1250, quantity: '1 peça', description: desc, category: flexC, kind: :product, height: 15.8, width: 15.8, length: 8.4, weight: 1.5, sap_code: '00003' },
      { name: 'H-Max Diesel 1.0 a 2.0', price_cents: 280000, binary_score: 730, quantity: '1 peça', description: desc, category: dieC, kind: :product, height: 15.8, width: 15.8, length: 8.4, weight: 1.5, sap_code: '00004' },
      { name: 'H-Max Diesel 2.1 a 3.4', price_cents: 380000, binary_score: 950, quantity: '1 peça', description: desc, category: dieC, kind: :product, height: 15.8, width: 15.8, length: 8.4, weight: 1.5, sap_code: '00083' },
      { name: 'H-Max Diesel 3.5 a 5.2', price_cents: 500000, binary_score: 1250, quantity: '1 peça', description: desc, category: dieC, kind: :product, height: 15.8, width: 15.8, length: 8.4, weight: 1.5, sap_code: '00084' },
