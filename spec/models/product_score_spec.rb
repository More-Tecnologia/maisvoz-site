...
RSpec.describe ProductScore, type: :model do
  ...
  it { is_expected.to validate_presence_of(:receiving_maximum_generation) }
  it { is_expected.to validate_numericality_of(:receiving_maximum_generation).only_integer }
end
